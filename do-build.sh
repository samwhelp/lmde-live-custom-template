...
TARGET_HOSTNAME="lmde"
TARGET_BUILD_VERSION="7"
...
#DEBOOTSTRAP_SCRIPT_FILE_NAME="bookworm"
#DEBOOTSTRAP_SCRIPT_FILE_NAME="trixie"
#DEBOOTSTRAP_SCRIPT_FILE_PATH="${DEBOOTSTRAP_SCRIPTS_DIR_PATH}/${DEBOOTSTRAP_SCRIPT_FILE_NAME}"
DEBOOTSTRAP_SCRIPT_FILE_PATH=""


TARGET_LMDE_CODENAME="gigi"
TARGET_LMDE_MIRROR="http://packages.linuxmint.com"
...
TARGET_LMDE_CODENAME="${TARGET_LMDE_CODENAME}"
TARGET_LMDE_MIRROR="${TARGET_LMDE_MIRROR}"
...
function core_var_dump () {
	...
	echo "TARGET_LMDE_CODENAME=\${TARGET_LMDE_CODENAME}"
	echo "TARGET_LMDE_MIRROR=\${TARGET_LMDE_MIRROR}"
...
function core_var_export () {
	...
	export TARGET_LMDE_CODENAME
	export TARGET_LMDE_MIRROR
